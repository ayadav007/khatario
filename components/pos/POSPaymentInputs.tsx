    ...
    <div className="space-y-4">
            ...
            <div key={method.mode} className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <Input
                  ...
                  placeholder="0.00"
                  className="text-right font-mono text-display-lg font-bold"
                />
              </div>
            </div>
          );
      ...
      {cashAmount > 0 && (
        <div className="bg-gray-50 border border-border rounded-lg p-3 space-y-2">
          <div className="flex justify-between items-center">
            <span className="text-display font-semibold text-text-secondary">Customer Paid:</span>
      ...
      {balance > 0 && (
        <div className="border-t pt-3">
          <div className="flex justify-between items-center">
            <span className="text-display font-semibold text-gray-700">Balance Due:</span>
            <span className="text-display-lg font-bold text-red-600">
