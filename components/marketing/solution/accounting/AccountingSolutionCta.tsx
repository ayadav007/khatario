...
export function AccountingSolutionCta() {
  return (
    <section className="border-t border-slate-800 bg-slate-900 py-16 2xl:py-24" aria-labelledby="accounting-cta-heading">
      <div className={`${LANDING_PAGE_GUTTER} w-full`}>
        <div className={LANDING_SECTION_INTRO}>
          <h2 id="accounting-cta-heading" className="text-3xl font-bold text-white sm:text-4xl 2xl:text-5xl">
            Ready for calmer books?
          </h2>
          <p className="mt-4 max-w-3xl text-lg text-slate-300 md:mx-0 2xl:mt-5 2xl:max-w-4xl 2xl:text-xl 2xl:leading-relaxed">
            Try Khatario on your real invoices and purchases — see GST accounting stay aligned without extra homework.
          </p>
          <p className="mt-2 text-sm text-slate-400 2xl:text-base">Start free · Book a walkthrough anytime</p>
