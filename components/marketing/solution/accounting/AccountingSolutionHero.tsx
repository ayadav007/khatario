...
export function AccountingSolutionHero() {
  return (
      ...
      <div className={`${LANDING_PAGE_GUTTER} w-full`}>
        <div className={LANDING_SECTION_INTRO}>
          ...
          <h1 className="mt-6 text-4xl font-bold tracking-tight text-slate-900 sm:text-5xl 2xl:text-6xl 2xl:leading-[1.1]">
            Simple accounting built into how you already work
          </h1>
          <p className="mx-auto mt-5 max-w-3xl text-lg leading-relaxed text-slate-600 md:mx-0 2xl:mt-6 2xl:max-w-4xl 2xl:text-xl 2xl:leading-relaxed">
            Khatario automatically converts business activities like invoices, purchases, and expenses into proper
            accounting entries without requiring accounting knowledge.
          </p>
          ...
          <p className="mt-4 text-sm text-slate-500 2xl:text-base">No accounting degree needed to get started.</p>
        </div>
      </div>
    </section>
  );
