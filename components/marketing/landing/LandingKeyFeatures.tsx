  ...
  return (
    <section className="scroll-mt-24 border-t border-slate-200/80 bg-slate-50/90 py-20 2xl:py-24">
      <div className={LANDING_PAGE_GUTTER}>
        <LandingReveal>
          <div className={LANDING_SECTION_INTRO}>
            <h2 className="text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl 2xl:text-5xl">
              Everything in one app — explained by outcomes
            </h2>
        ...
        >
          {FEATURES.map(({ id, icon: Icon, title, benefit }, i) => (
            <LandingReveal key={id} delay={i * 70}>
              <div
                id={id}
                className="scroll-mt-24 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-md 2xl:p-8 2xl:shadow"
              >
                <Icon
