    ...
    <section className="scroll-mt-24 bg-slate-50/90 py-20 2xl:py-24">
      <div className={LANDING_PAGE_GUTTER}>
        ...
        <div className={`mt-14 w-full space-y-6 2xl:mt-16 ${LANDING_MAX_MEDIUM}`}>
          {ROWS.map((row, i) => (
            <LandingReveal key={row.problem} delay={i * 90}>
              <div className="grid gap-0 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition duration-300 hover:shadow-md md:grid-cols-2 2xl:shadow-md">
