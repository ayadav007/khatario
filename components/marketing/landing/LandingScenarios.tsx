    ...
    <section className="border-y border-slate-200/80 bg-slate-50/90 py-20 2xl:py-24">
      <div className={LANDING_PAGE_GUTTER}>
        ...
        <div className="mt-10 max-sm:-mx-4 sm:mt-12">
          ...
          >
            {SCENARIOS.map((s, i) => (
              <LandingReveal key={s.title} delay={i * 60} className="max-sm:min-w-[18rem] max-sm:shrink-0 max-sm:snap-center sm:min-w-0">
                <div className="h-full rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-md 2xl:p-6 2xl:shadow">
