...
export const Button: React.FC<ButtonProps> = ({
  ...
  const sizeClasses = {
    /** Mobile-dense paddings scale up from md (~768px) */
    sm: 'px-3 py-1.5 text-xs min-h-9 md:px-4 md:py-2 md:text-sm md:min-h-[2.375rem]',
    md: 'px-4 py-2 text-sm min-h-10 md:px-6 md:py-2.5 md:text-base md:min-h-[2.75rem]',
    lg: 'px-5 py-2.5 text-base min-h-11 md:px-8 md:py-3 md:text-lg md:min-h-[3rem]',
  };
