...
/** sessionStorage key: catalogue item chosen on /purchases/new/select-item for /purchases/new */
export const PURCHASE_ITEM_PICK_RESULT_KEY = 'khatario_purchase_item_pick_result_v1';
