 ...
 *
 * Bluetooth printing uses native Classic SPP (`KhatarioBluetoothSppPlugin`)
 * plus `@capacitor-community/bluetooth-le` for BLE printers.
 * Device contacts (add customer from the phone book) use @capacitor/contacts.
